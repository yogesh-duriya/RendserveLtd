...
public class AddLabourActivity extends AppCompatActivity {
    ...
    private EditText et_name, et_labour, et_work_hour, et_travel_hour;
    ...
    private void setListener() {
        tv_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("labour" , et_labour.getText().toString());
    ...
    private void initialize() {
        ...
        et_labour = (EditText)findViewById(R.id.et_labour);
